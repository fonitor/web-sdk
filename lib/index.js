...
class Queue {
    ...
    constructor(options) {
        ...
        // 进行参数合并
        config = (!util$5.isBlank(options) && util$5.isType().isPlainObject(options)) ? Object.assign(config, options) : config;
        ...
        this.synRequestNum = !util$5.isBlank(config.synRequestNum) ? config.synRequestNum : 4;
        // 版本号
        this.ver = config.ver;
        this.synNum = 0;
    }
